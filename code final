...
#define INFLUXDB_HOST "185.98.128.237"   //Enter IP of device running Influx Database
#define INFLUXDB_PORT 48086
#define WIFI_SSID "RUT955_TENEZIS"              //Enter SSID of your WIFI Access Point
#define WIFI_PASS "1234567890"  //Enter Password of your WIFI Access Point
...
etatdefaut = digitalRead(buttonPin);
if (etatdefaut == HIGH) {
    // turn LED on
...
etatmarche = digitalRead(marchePin);
if (etatmarche == HIGH) {
    // turn LED on
